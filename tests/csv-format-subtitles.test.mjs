...
test('mostra os formatos dos CSVs diretamente nos subtitulos', () => {
  assert.match(source, /CSV colunas mínimas: NOME; CEP; ENDEREÇO; NUMERO; BAIRRO; CIDADE; UF/);
  assert.match(source, /CSV do Portal Postal: OBJETO; SERVICO; DESTINATARIO; CPF_CNPJ; ENDERECO; NUM; COMPLEMENTO; BAIRRO; CIDADE; UF; CEP; CONTEUDO; CODIGO_PP/);

...
test("preflight exige valor e documento antes de liberar",()=>{const src=read("apps-script/ProductionDce.gs");assert.match(src,/Documento do destinatario invalido/);assert.match(src,/Valor declarado deve ser maior ou igual/);assert.match(src,/STATUS:'DCE_PREPARED'/)});

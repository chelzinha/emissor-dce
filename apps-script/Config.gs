const DCE_CONFIG = Object.freeze({
  ...
  SHEETS: Object.freeze({
    ...
    DCE: ['ID', 'USER_ID', 'BATCH_ID', 'REMITTANCE_ID', 'CNPJ', 'SERIES', 'NUMBER', 'NUMERIC_CODE', 'ACCESS_KEY', 'STATUS', 'CSTAT', 'REASON', 'PROTOCOL', 'QR_CODE', 'AUTHORIZED_AT', 'SIGNED_XML_FILE_ID', 'PROCESSED_XML_FILE_ID', 'DACE_FILE_ID', 'CREATED_AT', 'UPDATED_AT'],
    ...
    POSTAL_RATE_TABLES: ['ID', 'CAMPAIGN_ID', 'NAME', 'STATUS', 'ORIGIN_ZIP', 'VALID_FROM', 'VALID_TO', 'TOTAL_ROWS', 'CREATED_BY', 'CREATED_AT', 'UPDATED_AT'],
    POSTAL_RATE_ROWS: ['ID', 'CAMPAIGN_ID', 'RATE_TABLE_ID', 'SERVICE', 'ZIP_START', 'ZIP_END', 'WEIGHT_FROM_G', 'WEIGHT_TO_G', 'PRICE', 'DEADLINE_DAYS', 'REGION', 'CREATED_AT'],
    TRACKING_EVENTS: ['ID', 'CAMPAIGN_ID', 'POSTAL_OBJECT_ID', 'TRACKING_CODE', 'SERVICE', 'CATEGORY', 'STATUS', 'DESCRIPTION', 'LOCATION', 'EVENT_AT', 'SOURCE', 'SOURCE_KEY', 'CREATED_BY', 'CREATED_AT'],
    ...
    FINANCE_IMPORTS: ['ID', 'CAMPAIGN_ID', 'FILE_NAME', 'FILE_HASH', 'STATUS', 'TOTAL_ROWS', 'INSERTED', 'DUPLICATES', 'CONFLICTS', 'TOTAL_AMOUNT', 'CREATED_BY', 'CREATED_AT', 'UPDATED_AT'],
    FINANCE_POSTINGS: ['ID', 'CAMPAIGN_ID', 'IMPORT_ID', 'TRACKING_CODE', 'POSTAL_OBJECT_ID', 'SERVICE', 'ECT_CODE', 'POSTING_DATE', 'LIST_ID', 'PP_CODE', 'QUANTITY', 'AMOUNT', 'SOURCE_KEY', 'SOURCE_JSON', 'CREATED_BY', 'CREATED_AT', 'UPDATED_AT'],
    FINANCE_PAYMENTS: ['ID', 'CAMPAIGN_ID', 'IDEMPOTENCY_KEY', 'PAYMENT_DATE', 'AMOUNT', 'METHOD', 'REFERENCE', 'NOTES', 'PROOF_FILE_ID', 'STATUS', 'CREATED_BY', 'CREATED_AT', 'UPDATED_AT'],
    FINANCE_ALLOCATIONS: ['ID', 'CAMPAIGN_ID', 'PAYMENT_ID', 'CHARGE_KEY', 'AMOUNT', 'STATUS', 'CREATED_BY', 'CREATED_AT'],

...
function doPost(event) {
  try {
    ...
    const handlers = {
      ...
      'portal.export': function() { return exportPortalPostal_(user.id, payload); },
      ...
      'production.prepare': function() { return prepareProductionBatch_(user.id, payload); },
      ...
      'production.posting.confirm': function() { return confirmProductionPosting_(user.id, payload); },
      ...
      'tracking.updates.append': function() { return trackingAppendUpdates_(user.id, payload); },
